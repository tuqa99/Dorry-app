...
class diagnosticQuiz extends StatefulWidget {
  const diagnosticQuiz({super.key});

  @override
  State<diagnosticQuiz> createState() => _diagnosticQuizState();
}

class _diagnosticQuizState extends State<diagnosticQuiz> {
