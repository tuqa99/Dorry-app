...
class level2 extends StatefulWidget {
  ...
  @override
  State<level2> createState() => _level21State();
}

class _level21State extends State<level2> {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child:
                    Text('Question $questionnumber/${level2questions.length}',
              ...
              Expanded(
                ...
                itemCount: level2questions.length,
                controller: controller,
                physics: NeverScrollableScrollPhysics(),
                itemBuilder: (context, index) {
                  final question = level2questions[index];
  ...
  ElevatedButton buildElevatedButton() {
    return ElevatedButton(
        onPressed: () {
          if (questionnumber < level2questions.length) {
            controller.nextPage(
        ...
        child: Text(questionnumber < level2questions.length
            ? 'Next Page'
            : 'See the Result'));
  }
}
